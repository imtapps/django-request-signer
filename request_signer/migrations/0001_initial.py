...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('request_signer_authorizedclient', (
            ...
            ('private_key', self.gf('django.db.models.fields.CharField')(
                default='ZTWXjy01_v-muyWoLMSYOteEniKiPuqVim1ah_dfd2A=',
                max_length=100)),
    ...
    models = {
        'request_signer.authorizedclient': {
            ...
            'private_key': ('django.db.models.fields.CharField', [], {
                'default':
                "'jAqUpViHFDNVg0IhGSaXxsi1RrhO9hHpmvUuiRr0q6I='",
                'max_length': '100'}),
